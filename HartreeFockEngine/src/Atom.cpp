...
Atom::Atom(int numBasisFunctions, double* a, Coordinate nucleiCoordinates, int nucleiQ, int numElecs) {
...
Atom::Atom(int numBasisFunctions, GaussianBasis* bases, Coordinate nucleiCoordinates, int nucleiQ, int numElecs) {
    numElectrons = numElecs;
    numBasisFuncs = numBasisFunctions;
    BasisFuncs = new GaussianBasis[numBasisFuncs];
